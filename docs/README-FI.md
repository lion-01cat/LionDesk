<p align="center">
  <img src="../res/logo-header.svg" alt="LionDesk - Etätyöpöytäsi"><br>
...
Juttele meidän kanssa: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/liondesk) | [Reddit](https://www.reddit.com/r/liondesk) | [YouTube](https://www.youtube.com/@liondesk)

[![LionDesk Server Pro](https://img.shields.io/badge/LionDesk%20Server%20Pro-Edistyneet%20Ominaisuudet-blue)](https://liondesk.com/pricing.html)

Vielä yksi etätyöpöytäohjelmisto, ohjelmoitu Rust-kielellä. Toimii suoraan pakkauksesta, ei tarvitse asetusta. Hallitset täysin tietojasi, ei tarvitse murehtia turvallisuutta. Voit käyttää meidän rendezvous/relay-palvelinta, [aseta omasi](https://liondesk.com/server), tai [kirjoittaa oma rendezvous/relay-palvelin](https://github.com/liondesk/liondesk-server-demo).

LionDesk toivottaa avustukset tervetulleiksi kaikilta. Katso lisätietoja [`docs/CONTRIBUTING.md`](CONTRIBUTING.md) avun saamiseksi.

[**BINAARILATAUS**](https://github.com/liondesk/liondesk/releases)
...
Varmista, että suoritat näitä komentoja LionDesktop-tietovaraston juurihakemistossa, muutoin sovellus ei ehkä löydä vaadittuja resursseja. Huomaa myös, että muita cargo-alikomentoja kuten `install` tai `run` ei nykyisin tueta tässä menetelmässä, koska ne asentavat tai suorittavat ohjelman säiliön sisällä eikä isäntäohjelman sisällä.

## Tiedostorakenne

- **[libs/hbb_common](https://github.com/liondesk/liondesk/tree/master/libs/hbb_common)**: video codec, config, tcp/udp wrapper, protobuf, fs-funktiot tiedostosiirtoon, ja jotkut muut apuohjelmafunktiot
- **[libs/scrap](https://github.com/liondesk/liondesk/tree/master/libs/scrap)**: näyttökaappaukset
- **[libs/enigo](https://github.com/liondesk/liondesk/tree/master/libs/enigo)**: platform specific keyboard/mouse control
- **[src/ui](https://github.com/liondesk/liondesk/tree/master/src/ui)**: Graafinen käyttöliittymä
