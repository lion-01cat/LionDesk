...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_DRIVER_INF_PATH = L"drivers\\LionDeskPrinterDriver\\LionDeskPrinterDriver.inf";
    LPCWCH RD_PRINTER_PORT = L"LionDesk Printer";
    LPCWCH RD_PRINTER_NAME = L"LionDesk Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"LionDesk v4 Printer Driver";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through LionDesk Printer.
