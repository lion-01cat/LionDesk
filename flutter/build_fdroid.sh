...
#
# Script to build F-Droid release of LionDesk
#
# Copyright (C) 2024, The LionDesk Authors
...
#
# - versionName from https://github.com/liondesk/liondesk/releases/download/fdroid-version/liondesk-version.txt
# - versionCode from https://github.com/liondesk/liondesk/releases/download/fdroid-version/liondesk-version.txt
...
prebuild)
	...
	# Install Flutter version for LionDesk library build
...
build)
	...
	cp "target/${RUST_TARGET}/release/liblibliondesk.so" \
		"flutter/android/app/src/main/jniLibs/${ANDROID_ABI}/libliondesk.so"
