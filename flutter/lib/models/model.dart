...
class FfiModel with ChangeNotifier {
  ...
  bool shouldAutoRetryOnOffline(
    ...
    if (type == 'error' &&
      ...
      // https://github.com/liondesk/liondesk/discussions/14048
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsLionDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsLionDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsLionDeskVirtualDisplays);
        }
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/liondesk/liondesk/pull/3706#issuecomment-1481242389
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get LionDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsLionDeskVirtualDisplays] ?? []);
  ...
  bool get isLionDeskIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'liondesk_idd';
