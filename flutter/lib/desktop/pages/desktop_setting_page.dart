...
class _AboutState extends State<_About> {
  ...
  Widget build(BuildContext context) {
    return futureBuilder(future: () async {
      ...
      return SingleChildScrollView(
        controller: scrollController,
        child: _Card(title: translate('About LionDesk'), children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const SizedBox(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://liondesk.com/privacy.html');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://liondesk.com');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
...
class _WaylandCardState extends State<WaylandCard> {
  ...
  //   "Settings" -> "Apps" -> "LionDesk" -> "Permissions" -> "Inhibit Shortcuts".
  // For resetting(clearing) the permission from the portal permission store, you can
  // use (replace <desktop-id> with the LionDesk desktop file ID):
  ...
  // On a native install this is typically "liondesk.desktop"; on Flatpak it is usually
  // the exported desktop ID derived from the Flatpak app-id (e.g. "com.liondesk.LionDesk.desktop").
  //
