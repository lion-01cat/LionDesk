...
class _RemotePageState extends State<RemotePage> with WidgetsBindingObserver {
  ...
  void onSoftKeyboardChanged(bool visible) {
    if (!visible) {
      ...
      // https://github.com/liondesk/liondesk/discussions/11843#discussioncomment-13499698 - Virtual keyboard issue
      if (isIOS) {
        _iosKeyboardWorkaroundTimer?.cancel();
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          // workaround for https://github.com/liondesk/liondesk/issues/3131
