...
///
/// Note:
/// On linux, we use dbus to communicate multiple liondesk process.
...
const DBUS_NAME: &str = "org.liondesk.liondesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "LionDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.liondesk.liondesk /dbus org.liondesk.liondesk.NewConnection string:'PEER_ID'`
