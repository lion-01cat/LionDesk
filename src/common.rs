...
// Because the url is always `https://api.liondesk.com/version/latest`.
#[tokio::main(flavor = "current_thread")]
...
#[inline]
pub fn is_liondesk() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("LionDesk")
}
...
fn get_api_server_(api: String, custom: String) -> String {
    ...
    "https://admin.liondesk.com".to_owned()
}

#[inline]
pub fn is_public(url: &str) -> bool {
    url.contains("liondesk.com/") || url.ends_with("liondesk.com")
}
...
pub fn check_process(arg: &str, mut same_uid: bool) -> bool {
    ...
    for (_, p) in sys.processes().iter() {
        ...
        // on mac, p.cmd() get "/Applications/LionDesk.app/Contents/MacOS/LionDesk", "XPC_SERVICE_NAME=com.carriez.LionDesk_server"
...
pub type LionDeskInterval = ThrottledInterval;

#[inline]
pub fn liondesk_interval(i: Interval) -> ThrottledInterval {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_LionDesk_interval() {
        ...
        for maker in base_intervals.into_iter() {
            ...
            let mut timer = liondesk_interval(maker());
    ...
    #[allow(non_snake_case)]
    #[tokio::test]
    async fn test_LionDesk_interval_sleep() {
        let base_intervals = [interval_maker, interval_at_maker];
    ...
    #[test]
    fn test_is_public() {
        // Test URLs containing "liondesk.com/"
        assert!(is_public("https://liondesk.com/"));
        assert!(is_public("https://www.liondesk.com/"));
        assert!(is_public("https://api.liondesk.com/v1"));
        assert!(is_public("https://liondesk.com/path"));

        // Test URLs ending with "liondesk.com"
        assert!(is_public("liondesk.com"));
        assert!(is_public("https://liondesk.com"));
        assert!(is_public("http://www.liondesk.com"));
        assert!(is_public("https://api.liondesk.com"));
        ...
        assert!(!is_public("https://liondesk.computer.com"));
        assert!(!is_public("liondesk.comhello.com"));
    }
