...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Σύνδεση στο δίκτυο LionDesk..."),
        ...
        ("install_tip", "Λόγω UAC, το LionDesk ενδέχεται να μην λειτουργεί σωστά σε ορισμένες περιπτώσεις. Για να αποφύγετε το UAC, κάντε κλικ στο κουμπί παρακάτω για να εγκαταστήσετε το LionDesk στο σύστημα"),
        ("Click to upgrade", "Κάντε κλίκ για αναβάθμιση τώρα"),
        ("Configure", "Διαμόρφωση"),
        ("config_acc", "Για να ελέγξετε την επιφάνεια εργασίας σας από απόσταση, πρέπει να παραχωρήσετε στο LionDesk το δικαίωμα της \"Προσβασιμότητας\"."),
        ("config_screen", "Για να αποκτήσετε απομακρυσμένη πρόσβαση στην επιφάνεια εργασίας σας, πρέπει να παραχωρήσετε στο LionDesk το δικαίωμα της \"Εγγραφή οθόνης\"."),
        ...
        ("android_input_permission_tip1", "Για να μπορεί μία απομακρυσμένη συσκευή να ελέγχει τη συσκευή σας Android, πρέπει να επιτρέψετε στο LionDesk να χρησιμοποιεί την υπηρεσία \"Προσβασιμότητα\"."),
        ("android_input_permission_tip2", "Παρακαλούμε να μεταβείτε στην επόμενη σελίδα ρυθμίσεων συστήματος, βρείτε και πληκτρολογήστε [Εγκατεστημένες υπηρεσίες], ενεργοποιήστε την υπηρεσία [Είσοδος LionDesk]."),
        ...
        ("Language", "Γλώσσα"),
        ("Keep LionDesk background service", "Διατήρηση της υπηρεσίας παρασκηνίου του LionDesk"),
        ...
        ("Show LionDesk", "Εμφάνιση του LionDesk"),
        ...
        ("config_input", "Για να ελέγξετε την απομακρυσμένη επιφάνεια εργασίας με το πληκτρολόγιο, πρέπει να παραχωρήσετε στο LionDesk το δικαίωμα της \"Παρακολούθηση εισόδου\"."),
        ("config_microphone", "Για να μιλήσετε εξ αποστάσεως, πρέπει να παραχωρήσετε στο LionDesk το δικαίωμα της \"Εγγραφή ήχου\"."),
        ...
        ("still_click_uac_tip", "Εξακολουθεί να απαιτεί από τον απομακρυσμένο χρήστη να κάνει κλικ στο πλήκτρο Εντάξει στο παράθυρο UAC όπου εκτελείται το LionDesk."),
        ...
        ("verify_liondesk_password_tip", "Επιβεβαιώστε τον κωδικό του LionDesk"),
        ...
        ("scam_text1", "Αν σας καλέσει κάποιος τον οποίο ΔΕΝ γνωρίζεται και ΔΕΝ ΕΜΠΙΣΤΕΥΕΣΤΕ, και σας ζητήσει να ανοίξετε το LionDesk, και να του πείτε τα στοιχεία που εμφανίζει, ΜΗΝ συνεχίσετε και κλείστε το τηλέφωνο ΑΜΕΣΩΣ."),
        ...
        ("upgrade_liondesk_server_pro_to_{}_tip", "Παρακαλώ ενημερώστε το LionDesk Server Pro στην έκδοση {} ή νεότερη!"),
        ...
        ("selinux_tip", "Το SELinux είναι ενεργοποιημένο στη συσκευή σας, κάτι που ενδέχεται να εμποδίσει την σωστή λειτουργία του LionDesk ως ελεγχόμενης πλευράς."),
        ...
        ("powered_by_me", "Με την υποστήριξη του LionDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Να επιτρέπεται η σύνδεση μόνο εάν το παράθυρο LionDesk είναι ανοιχτό"),
        ...
        ("floating_window_tip", "Βοηθά στη διατήρηση της υπηρεσίας παρασκηνίου LionDesk"),
        ...
        ("About LionDesk", "Πληροφορίες για το LionDesk"),
        ...
        ("upgrade_remote_liondesk_client_to_{}_tip", "Αναβαθμίστε τον πελάτη LionDesk στην έκδοση {} ή νεότερη στην απομακρυσμένη πλευρά!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Από προεπιλογή, το LionDesk επαληθεύει το πιστοποιητικό διακομιστή για πρωτόκολλα που χρησιμοποιούν TLS.\nΜε ενεργοποιημένη αυτήν την επιλογή, το LionDesk θα παρακάμψει το βήμα επαλήθευσης και θα προχωρήσει σε περίπτωση αποτυχίας επαλήθευσης."),
        ("Disable UDP", "Απενεργοποίηση UDP"),
        ("disable-udp-tip", "Ελέγχει εάν θα χρησιμοποιείται μόνο TCP.\nΌταν είναι ενεργοποιημένη αυτή η επιλογή, το LionDesk δεν θα χρησιμοποιεί πλέον το UDP 21116, αλλά θα χρησιμοποιείται το TCP 21116."),
        ("server-oss-not-support-tip", "ΣΗΜΕΙΩΣΗ: Το OSS του διακομιστή LionDesk δεν περιλαμβάνει αυτήν τη λειτουργία."),
