...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään LionDesk verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa LionDesk ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi LionDeskin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava LionDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava LionDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten LionDesk daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota LionDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli LionDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "LionDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa LionDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "LionDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep LionDesk background service", "Pidä LionDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista LionDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("verify_liondesk_password_tip", "Vahvista LionDesk salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "LionDesk ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("upgrade_liondesk_server_pro_to_{}_tip", "Päivitä LionDesk Server Pro versioon {} jatkaaksesi."),
        ...
        ("About LionDesk", "Tietoa LionDeskistä"),
        ...
        ("upgrade_remote_liondesk_client_to_{}_tip", "Päivitä etä-LionDesk-asiakasversioon {} yhteensopivuuden takaamiseksi"),
