...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Свързване с LionDesk мрежата..."),
        ...
        ("install_tip", "Поради UAC, LionDesk в някои случай не може да работи правилно за отдалечена достъп. За да заобиколите UAC, моля, натиснете копчето по-долу, за да поставите LionDesk като системна услуга."),
        ("Click to upgrade", "Натиснете, за да надстроите"),
        ("Configure", "Настройване"),
        ("config_acc", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на LionDesk права от раздел \"Достъпност\"."),
        ("config_screen", "За да управлявате вашия работна среда отдалечено, трябва да предоставите на LionDesk права от раздел \"Запис на екрана\"."),
        ...
        ("Discovered", "Открит"),
        ("install_daemon_tip", "За зареждане при стартиране на ОС трябва да инсталирате LionDesk като системна услуга."),
        ...
        ("android_input_permission_tip1", "За да може отдалечено устройство да управлява вашето Android устройство чрез мишка или допир, трябва да разрешите на LionDesk да използва услугата \"Достъпност\"."),
        ("android_input_permission_tip2", "Моля, отидете на следващата страница със системни настройки, намерете и въведете [Installed Services], включете услугата [LionDesk Input]."),
        ...
        ("Language", "Език"),
        ("Keep LionDesk background service", "Запази LionDesk фоновата услуга"),
        ("Ignore Battery Optimizations", "Игнорирай оптимизациите на батерията"),
        ("android_open_battery_optimizations_tip", "Ако искате да деактивирате тази функция, моля, отидете на следващата страница с настройки на приложението LionDesk, намерете и въведете [Battery], премахнете отметката от [Unrestricted]"),
        ...
        ("config_input", "За да управлявате отдалечена среда с клавиатура, трябва да предоставите на LionDesk право за \"Input Monitoring\"."),
        ("config_microphone", "За да говорите отдалечено, трябва да предоставите на LionDesk право за \"Запис на звук\"."),
        ...
        ("still_click_uac_tip", "Все още изисква отдалеченият потребител да натисне върху OK в прозореца на UAC при стартиран LionDesk."),
        ...
        ("verify_liondesk_password_tip", "Проверете LionDesk паролата"),
        ...
        ("scam_text1", "Ако разговаряте по телефона с някой, когото НЕ ПОЗНАВАТЕ и НЯМАТЕ ДОВЕРИЕ, който ви е помолил да използвате LionDesk и да стартирате услугата, не продължавайте и затворете незабавно."),
        ...
        ("upgrade_liondesk_server_pro_to_{}_tip", "Моля обновете LionDesk Server Pro на версия {} или по-нова!"),
        ...
        ("selinux_tip", "SELinux е активиран на вашето устройство, което може да попречи на LionDesk да работи правилно като контролирана страна."),
        ...
        ("new-version-of-{}-tip", ""),
        ("Accessible devices", ""),
        ("upgrade_remote_liondesk_client_to_{}_tip", "Моля, надстройте клиента LionDesk до версия {} или по-нова от отдалечената страна!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
